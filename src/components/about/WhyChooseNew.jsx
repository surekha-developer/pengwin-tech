...
//     rootMargin: "0px 0px -100px 0px" // 🔥 triggers earlier on mobile
//   }
// );
...
// <hr className={`${styles.divider} ${startCount ? styles.active : ""}`} />
...
<div
  ...
  className={`${styles.pointsGrid} ${
    pointsVisible ? styles.pointsActive : ""
  }`}
>
  {pointsData.map((point, index) => (
    <div
